...
const errors:ErrorObject = {
    ...
    "auth/user-not-found": "There is no user record corresponding to this email or username.",
...
export default function parseFirebaseError(error:any):Error{
    let defMessage='An unknown server error has occured. Please be advised we\'re working on it.';
    ...
    if(typeof error ==='string'){
        message=errors[error] || defMessage;
    }
